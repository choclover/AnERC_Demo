...
//	 */
//	@Override
//	public void handleRspvent(ErcEventRsp login)
//	{
//		// 登录界面只处理login事件的返回值
//		if (login.eventType == ErcEventRsp.RSP_LOGIN_EVENT) {
//			// 得到登录的返回消息
//			// TODO 需要处理各种情况，这里暂且假定登录成功
//			closeProgress();
//			if (!login.getCode().equalsIgnoreCase("ok")) {
//				showConfirmDialog("提示", login.getCode());
//			} else {
